...
export default function OfficerSidebar({ currentStep = 1, completedSteps = [] }) {
  const steps = [
    { id: 1, name: 'Basic Details', desc: 'Personal & contact info' },
    { id: 2, name: 'Institution Details', desc: 'University & department info' },
    ...
    <aside className="wizard-sidebar">
      <div>
        ...
        <div className="sidebar-heading">
          <h1 className="sidebar-title">Officer Registration</h1>
          <p className="sidebar-subtitle">Setup placement officer portal</p>
        </div>
      ...
      <div className="sidebar-help-card">
        ...
        <div className="help-desc">Our officer support team is available 24/7.</div>
